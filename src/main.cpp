...
/** Amount of hashcoins spent by the transaction.
...
static const int64 nMinSubsidy = 1024 * COIN;
...
static const int64 nTargetTimespan = 7200; // 2 minutes
static const int64 nTargetSpacing = 10; // 60 seconds
...
{
	static const int64 BlocksTargetSpacing = 1 * 10; // 60 seconds
...
void ThreadScriptCheck() {
    RenameThread("hashcoin-scriptch");
