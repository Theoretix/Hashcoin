...
#ifndef H_HASHCOIN_SCRIPT
#define H_HASHCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CHashcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Hashcoin always counted CHECKMULTISIGs
