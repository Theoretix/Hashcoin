...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: HashCoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: HashCoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 4033 or testnet: 14033)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 4032 or testnet: 14032)") + "\n";
    ...
    strUsage += "\n" + _("SSL options: (see the Hashcoin Wiki for SSL setup instructions)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Hashcoin process is using the data directory.
    ...
    // requested to kill hashcoin-qt during the last operation. If so, exit.
