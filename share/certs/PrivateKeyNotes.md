...
unlocked to sign the Hashcoin-Qt.app bundle.
...
allowing somebody to distribute a Hashcoin-Qt.app or hashcoin-qt-setup.exe with a valid
...
that the hashcoin-qt.exe file inside the installer had not been tampered with.
